        ...
        <div className=" py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-bold mb-6">About Northgate Automation</h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
                    <div className="bg-bg-container p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                        <div className="w-16 h-16 bg-blue-100 rounded-lg flex items-center justify-center mb-6">
                            <svg className="w-8 h-8 text-blue-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                            </svg>
                        </div>
                        <h3 className="text-xl font-semibold mb-4">Identify & Analyze</h3>
                        <p>
                    ...
                    <div className="bg-bg-container p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                        ...
                        <h3 className="text-xl font-semibold  mb-4">Design & Blueprint</h3>
                        <p className="">
                    ...
                    <div className="bg-bg-container p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                        ...
                        <h3 className="text-xl font-semibold  mb-4">Implement & Optimize</h3>
                        <p className="">
                ...
                <div className="bg-bg-container rounded-xl shadow-lg p-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            <h3 className="text-2xl font-semibold  mb-6">Why Choose Northgate Automation?</h3>
                            <div className="space-y-4">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="">Successful delivery of complex automation projects across various industries</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="">Custom automation strategies designed specifically for your business needs</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="">Comprehensive training and support to ensure your team maximizes automation benefits</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div className="text-center">
                                ...
                                <div className="">Automation Projects</div>
                            </div>
                            <div className="text-center">
                            ...
                            <div className="text-center">
                                ...
                                <div className="">Expert Team Members</div>
                            </div>
                            <div className="text-center">
